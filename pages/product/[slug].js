...
const ProductDetails = ({ product, products }) => {
    const { image, name, details, originalPrice, discountedPrice } = product;
            ...
            <div className="product-detail-container">
                ...
                <div className="product-detail-desc">
                    ...
                    <div className="buttons">
                        ...
                        <button type="button" className="add-to-wishlist" onClick={() => onAdd(product, qty)}>Add To Wishlist</button>
                    </div>
                </div>
            </div>
